        ...
        protected JComponent getHelpComponent() {
          final String helpContent = 
                              ...
                              "It reads the source code instruction and generates an animation representing the inputs and \n"+
             						...
             						"Version 2.0\n" + 
             						"Developed by MÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡rcio Roberto, Guilherme Sales, FabrÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­cio Vivas, FlÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡vio Cardeal and FÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡bio LÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂºcio\n" +
